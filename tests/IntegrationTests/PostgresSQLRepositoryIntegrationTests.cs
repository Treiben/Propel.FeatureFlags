...
*/
public class CreateAsync_WithValidFlag : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public CreateAsync_WithValidFlag(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
...
public class When_FlagExists : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public When_FlagExists(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
	...
	public async Task If_GetAndFlagHasComplexData_ThenDeserializesCorrectly()
	{
		...
		result.TargetingRules[0].Operator.ShouldBe(TargetingOperator.In);
...
public class When_FlagDoesNotExist : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public When_FlagDoesNotExist(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
...
public class GetExpiringAsync_WithExpiringFlags : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public GetExpiringAsync_WithExpiringFlags(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
...
public class GetByTagsAsync_WithMatchingTags : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public GetByTagsAsync_WithMatchingTags(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
...
public class PostgreSQLFeatureFlagRepository_CancellationToken : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public PostgreSQLFeatureFlagRepository_CancellationToken(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}
...
public class PostgreSQLFeatureFlagRepository_DatabaseErrors : IClassFixture<PostgreSQLFeatureFlagRepositoryFixture>
{
	private readonly PostgreSQLFeatureFlagRepositoryFixture _fixture;

	public PostgreSQLFeatureFlagRepository_DatabaseErrors(PostgreSQLFeatureFlagRepositoryFixture fixture)
	{
		_fixture = fixture;
	}

	[Fact]
	public async Task If_DuplicateKey_ThenThrowsNpgsqlException()
	{
		// Arrange
		await _fixture.ClearAllFlags();
	...
	[Fact]
	public async Task If_InvalidConnectionString_ThenThrowsArgumentException()
	{
		// Arrange
...
public class PostgreSQLFeatureFlagRepositoryFixture : IAsyncLifetime
{
	...
	public PostgreSQLFeatureFlagRepositoryFixture()
	{
