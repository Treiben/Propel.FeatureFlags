...
public static class FlagRegistrationExtensions
{
	//Ensure feature flags in database
	public static async Task RegisterPropelFlagsAsync(this IFeatureFlag flag,
		...
		CancellationToken cancellationToken = default)
	{
		...
		var description = flag.Description ?? $"Auto-created flag for {flag.Key} in application {ApplicationInfo.Name}";
		try
		{
