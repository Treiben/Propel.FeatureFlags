...
public class StringTargetingRule : ITargetingRule<string>
{
	...
	public bool EvaluateFor(string value)
	{
		...
		{
			TargetingOperator.Equals => Values.Contains(value, StringComparer.OrdinalIgnoreCase),
...
{
	public static ITargetingRule CreaterTargetingRule(string attribute, TargetingOperator op, List<string> values, string variation)
	{
