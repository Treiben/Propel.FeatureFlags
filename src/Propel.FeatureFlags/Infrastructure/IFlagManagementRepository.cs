...
public interface IFlagManagementRepository
{
	...
	Task<bool> DeleteAsync(FlagKey flagKey, string userid, string reason, CancellationToken cancellationToken = default);
}
