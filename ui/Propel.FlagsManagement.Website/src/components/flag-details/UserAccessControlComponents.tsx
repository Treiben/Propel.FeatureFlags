        ...
        <div className="space-y-4 mb-6">
            ...
            {editingUserAccess ? (
                ...
                <div className="text-sm text-gray-600 space-y-1">
                    <div>Percentage: {flag.userRolloutPercentage || 0}%</div>
                    <div>Allowed Users: {flag.allowedUsers?.length || 0}</div>
                    <div>Blocked Users: {flag.blockedUsers?.length || 0}</div>
                    ...
                    {flag.allowedUsers && flag.allowedUsers.length > 0 && (
                        <div className="mt-2">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                                {flag.allowedUsers.slice(0, 5).map((user) => (
                                    <span
                                        key={user}
                                ...
                                {flag.allowedUsers.length > 5 && (
                                    <span className="text-xs text-gray-500">+{flag.allowedUsers.length - 5} more</span>
                                )}
                            </div>
                        </div>
                    )}
                    ...
                    {flag.blockedUsers && flag.blockedUsers.length > 0 && (
                        <div className="mt-2">
                            ...
                            <div className="flex flex-wrap gap-1 mt-1">
                                {flag.blockedUsers.slice(0, 5).map((user) => (
                                    <span
                                        key={user}
                                ...
                                {flag.blockedUsers.length > 5 && (
                                    <span className="text-xs text-gray-500">+{flag.blockedUsers.length - 5} more</span>
                                )}
                            </div>
                        </div>
                    )}
