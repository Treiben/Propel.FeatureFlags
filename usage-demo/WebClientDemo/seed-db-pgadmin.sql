...
SET search_path TO web_client_demo;
...
------------------------------------------------------------------------
SET my.flag_key = 'new-email-service';
...
INSERT INTO feature_flags_metadata (flag_key, application_name, application_version, tags, expiration_date)
VALUES (current_setting('my.flag_key'), current_setting('my.app_name'), current_setting('my.app_version'), '{"category": "infrastructure", "type": "implementation-toggle", "impact": "medium", "team": "platform", "rollback": "automatic"}', NOW() + INTERVAL '1 year');
