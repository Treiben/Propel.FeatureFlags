...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'FeatureFlags' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'FeatureFlagsMetadata' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
...
IF NOT EXISTS (SELECT * FROM sys.tables WHERE name = 'FeatureFlagsAudit' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
